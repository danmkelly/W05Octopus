---
name: designer
description: Red-Orange Designer: creates solutions, architectures, wireframes, and experience designs. Use when you need system architecture, UX/UI design, wireframes, or buildable specs for the Maker agent.
mode: subagent
---
